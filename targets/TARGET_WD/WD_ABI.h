...
/*
	...
	int SIZE (0 by default, written by ELF-Tool)
	int CPUID-MASK:	FFF0FFF0
	int CPUID:		4100C240
...
#define WD_ABI_HDR_APP		0x01		// this is a header of the application
#define WD_ABI_HDR_BL		0x02		// this is a header of the bootloader
